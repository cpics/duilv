        ...
        <div class="m-container m-width">
            ...
            <div class="project-trace-content">
                <div class="m-second-tabs">
                    <span :class="{'active':params.type=='all'}"
                          @click="getData('all')">全部</span>
                    <span class="u-line">|</span>
                    <span :class="{'active':params.type=='qe'}"
                          @click="getData('qe')">QE报告</span>
                    <span class="u-line">|</span>
                    <span :class="{'active':params.type=='report'}"
                          @click="getData('report')">周报</span>
                </div>
