<template>
    <div class="top-menu">
        <ul class="top-menu-list">
            <li v-for="(item,index) in menuRouter"
                :key="index">
                <router-link v-if="item.name!='originality'"
                             tag="a"
                             class="top-m-item"
                             :to="item">{{item.meta.title}}</router-link>

                <a v-if="item.name=='originality'"
                   :class="{'active':originalityDir}"
                   class="top-m-item">{{item.meta.title}}</a>
                <div v-if="item.name=='originality'"
                     class="second-menu">
                    <div class="second-menu-inner">
                        <div class="second-m-box">
                            <div class="second-m-row"
                                 v-for="(jxj,i) in jxjSubMenu.parents"
                                 :key="i">
                                ...
                                <div class="second-info">
                                    <router-link tag="a"
                                                 ...
                                                 class="second-item">{{child.title}}</router-link>
                                </div>
                            </div>
                        </div>
                        <div class="second-button">
                            <span class="dm-btn dm-btn-default"
                                  @click="goApply">申请匠心记+</span>
                        </div>
                    </div>
                </div>
            </li>
